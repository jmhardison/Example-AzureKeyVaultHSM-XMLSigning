...
class Program
    {
        ...
        internal static string KeyVersion;
        ...
        static void Main(string[] args)
        {
            try{
                ...
                if(ValidateFile != null)
                {
                    ...
                    publicCertBundle = keyVault.GetCertificateAsync(KeyVaultAddress, KeyName).Result;
        ...
        private static void ProcessArgs(string[] args){
            if(args.Length > 0){
                for(int i =0; i < args.Length; i++){
                    ...
                    else if(args[i].StartsWith("-keyname")){
                        KeyName = args[i+1];
                    }
                    ...
                    else if(args[i].StartsWith("-keyversion")){
                        KeyVersion = args[i+1];
                    }
                }
            }
        ...
        private static void PrintHelp(){
            ...
            Console.WriteLine("-------------------------------------------------------------------------------\n");
            Console.WriteLine("Example: cli-exakvdocsign -aadclientid 123 -aadclientsecret 123= -keyvaulturl https://dog.vault.azure.net/ -keyname bob -filetosign filename.txt\n");
            Console.WriteLine("===============================================================================\n");
            Environment.Exit(-1);
        }
